# Generated by Django 2.1 on 2018-11-20 08:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active_post', models.BooleanField(default=True, null=True)),
                ...
                ('volunteers', models.ManyToManyField(blank=True, related_name='assignvolunteer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
